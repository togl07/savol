...
<body>
  ...
  <div class="hero_area">
    ...
    <header class="header_section long_section px-0">
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        <a class="navbar-brand" href="index.html">
          <object data="images/brend.svg" type="image/svg+xml" width="100" height="40"></object>
        </a>
      ...
      <div class="container">
        <div class="contact_nav">
          <a href="">
            ...
            <span>
              Call : +998 99 123 45 67
            </span>
          </a>
          <a href="">
            <i class="fa fa-envelope" aria-hidden="true"></i>
            <span>
              Email : savolkerakteam@gmail.com
            </span>
          </a>
          <a href="">
    ...
    <footer class="footer_section">
      <div class="container">
        <p>
          &copy; <span id="displayYear"></span> Hamma Huquqlar
          <a href="#">SavolKerak Sayti tomonidan himoyalangan</a>
        </p>
      </div>
    </footer>
    <!-- footer section -->
